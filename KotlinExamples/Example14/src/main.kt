...
// 동물원 관리하는 클래스
// 동물들의 행동 출력하게 하는 기능 - 동물원 ✅
// 5. 동물들의 정보 입력하는 기능 - 동물원 ✅
// 6. 동물들의 정보 출력하는 기능 - 동물원 ✅
 class ZooManage {
     private val scanner = Scanner(System.`in`)

    private val s1 = Tiger()
    private val s2 = Tiger()
    private val s3 = Lion()
    private val s4 = Lion()
    private val s5 = Fox()
    private val s6 = Fox()
    ...
    fun inputAnimalsInfo() {
        s1.inputTigerInfo(scanner)
        s2.inputTigerInfo(scanner)
        s3.inputLionInfo(scanner)
        s4.inputLionInfo(scanner)
        s5.inputFoxInfo(scanner)
        s6.inputFoxInfo(scanner)
    }
...
// 7. 동물 각각의 정보 입력하는 기능 - 호랑이, 사자, 여우 ✅
// 8. 동물 각각의 정보 출력하는 기능 - 호랑이, 사자, 여우 ✅
// 동물들이 상속받을 클래스 - 중복되는 메소드만 모아놓음. -> Super Class
open class Animal(var animalType: String) { // 동물 종류 => 주 생성자
    // 동물 이름
    var animalName = ""
