...
class TestClass1(var a1: Int, var a2: Int) {
    // 더하기 연산자를 사용하면 호출되는 메소드
    // 연산자를 기준으로 좌측의 객체를 통해 메소드가 호출
    // 매개변수로 우측에 있는 객체의 주소값이 전달됨.
    ...
    operator fun minus(target: TestClass1) : TestClass1 {
        val r3 = this.a1 - target.a1
        val r4 = this.a2 - target.a2

        val result = TestClass1(r3, r4)
        return result
    }
