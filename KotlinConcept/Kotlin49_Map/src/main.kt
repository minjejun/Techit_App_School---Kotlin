...
fun main() {
    ...
    // 다양한 타입의 값을 담을 수 있음.
    val map4 = mapOf("key1" to 10, "key2" to 22.22, "key3" to "임세나 연락 없어")
    println("map4: $map4")

    // 제네릭을 설정할 수 잇음
    // map은 제네릭은 설정하지 않아도 되지만 딱 한 경우에는 무조건 설정해야 함.
    ...
    // 텅 비어있는 맵을 만들 때는 반드시 제네릭을 설정해야 함.
