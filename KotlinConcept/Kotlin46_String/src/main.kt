...
fun main() {
    ...
    // 문자열을 구성하는 글자의 코드값을 합산, 그걸 뺀 결과를 반환.
    ...
    // equals 메소드의 두 번째 매개변수에 true를 넣어주면 대소문자를 무시하고 같은지 비교.
    if(str4.equals(str5, true)) {
        println("두 문자열은 대소문자를 무시하면 같음.")
    }
    ...
    // upperCase : 소문자를 대문자로 하는 문자열을 생성.
    // lowerCase : 대문다를 소문자로 하는 문자열 생성.
